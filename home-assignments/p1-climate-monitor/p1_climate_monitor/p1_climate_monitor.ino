/*
  ...
  NOTE: Kit sheet assumes an I2C OLED, but this build uses the 7-pin SPI
  SSD1306 module actually included in the kit. Wiring/library calls below
  are adapted for SPI accordingly (see README for full pin table).
*/
